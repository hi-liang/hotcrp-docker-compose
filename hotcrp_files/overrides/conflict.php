...
class Conflict {
    ...
    static private $desc_map = [
        ...
        12 => "Co-worker",
        6 => "Institutional",
        14 => "Research collaborator",
        16 => "Funding collaborator",
        4 => "Advisor",
        18 => "Advisee",
        8 => "Personal",
        10 => "Other (please submit explanation)",
    ];
    static private $json_map = [
        2 => "coauthor",
        12 => "coworker",        
        6 => "institutional",
        14 => "research_collaborator",
        16 => "funding_collaborator",
        4 => "advisor",
        18 => "advisee",
        8 => "personal",
        10 => "other",
    ...
    function parse_assignment($text, $old) {
        ...
        foreach (explode(" ", strtolower($text)) as $w) {
            ...
            if ($w === "pin" || $w === "pinned") {
                ...
                $xct = 12;
            } else if ($w === "research_collaborator") {
                $xct = 14;
            } else if ($w === "funding_collaborator") {
                $xct = 16;
            } else if ($w === "advisee") {
                $xct = 18;
